...
<html>
  ...
  <body >
	...
	<form name="form1" class="form-horizontal" action="${pageContext.request.contextPath}/admin/huiyuanmanager.do"  id="form1" method="post"  >
                  <input type="hidden" name="actiontype" value="modifyPw"/>
				  <input type="hidden"  name="id" value="${huiyuan.id}"/>
				  <input type="hidden"  name="forwardurl"  value="/huiyuan/accountinfo.jsp?seedid=101"/>
				  <input type="hidden"  name="errorpageurl"  value="/huiyuan/modifypw.jsp?seedid=101"/>
