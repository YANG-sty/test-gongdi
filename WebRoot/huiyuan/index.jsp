...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		<header class="main-header"> <!-- Logo --> <a
			...
			<span class="logo-mini">工地</span> <!-- logo for regular state and mobile devices -->
			<span class="logo-lg"><b>工地管理</b>系统</span>
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<img
						src="${huiyuan.photo}" class="user-image"
						alt="User Image"> <span class="hidden-xs">${huiyuan.accountname}</span>
				</a>
					<ul class="dropdown-menu">
						<!-- User image -->
						<li class="user-header"><img src="${huiyuan.photo}"
							class="img-circle">
						...
						<li class="user-footer">
							<div class="pull-left">
								<a href="${pageContext.request.contextPath}/huiyuan/modifyinfo.jsp" target="main"  class="btn btn-default btn-flat">编辑账户</a>
							</div>
...
<aside class="main-sidebar">
    ...
    <!-- /.sidebar -->
	  ...
	  <div class="content-wrapper">
	      ...
	      <iframe src="${pageContext.request.contextPath}/huiyuan/accountinfo.jsp"     frameborder="0" width="100%" height="100%"  name="main"
                        id="main">
          </iframe>
	  </div>
    ...
    <strong>Copyright &copy; 2019-2022 All rights ylf
    reserved.
  </footer>
