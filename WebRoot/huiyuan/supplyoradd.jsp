	...
	<form name="supplyorform" method="post"
		...
		<table class="grid" cellspacing="1" width="100%">
			...
			<input type="hidden" name="forwardurl"
				value="/admin/supplyormanager.do?actiontype=get&hyid=${huiyuan.id}&forwardurl=/huiyuan/supplyormanager.jsp" />
			<tr>
			...
			<tr>
				...
				<td><input name="tel" placeholder="电话"
					validate="{required:true,mobile:true,messages:{required:'请输入电话'}}"
			...
			<tr>
				...
				<td><input name="email" placeholder="邮箱"
					validate="{required:true,email:true,messages:{required:'请输入邮箱'}}"
			...
			<tr>
				...
				<td colspan="3"><textarea name="des" rows="4" id="txtDes"
						style="width:48%;height:100px;" validate="{required:true}">${requestScope.supplyor.des}</textarea>
				</td>
			</tr>
			<tr>
				<td colspan="4">
