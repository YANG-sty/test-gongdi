...
<html>
			...
			$(function() {
				$("#btnDelete").click(function(){
				       var ids = $(".check[type=checkbox]:checked").serialize();
						...
						$.ajax({
				                    url: "${pageContext.request.contextPath}/admin/supplyormanager.do?actiontype=delete",
				                     method: 'post',
				                     data: ids,
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/supplyormanager.do?actiontype=load&forwardurl=/huiyuan/supplyoradd.jsp">新建供应商</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
				...
				<tbody>
					<tr>
						<td>名称 <input name="name" value="${name}" class="input-txt"
							...
							value="/huiyuan/supplyormanager.jsp" />
							<div class="ui-button">
	...
	<table id="supplyor" width="100%" border="0" cellspacing="0"
		...
		<tbody>
			...
			<tr>
				...
				<td><%=temsupplyor.getDes()%></td>
				<td><a class="orange-href"
					href="${pageContext.request.contextPath}/admin/supplyormanager.do?actiontype=load&id=<%=temsupplyor.getId()%>&forwardurl=/admin/supplyoradd.jsp"><i
						class="icon-edit icon-white"></i>修改</a> <a class="orange-href"
					href="${pageContext.request.contextPath}/admin/supplyordetails.jsp?id=<%=temsupplyor.getId()%>"><i
