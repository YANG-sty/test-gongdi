	...
	<form name="zhiyuanform" method="post" action="${pageContext.request.contextPath}/admin/zhiyuanmanager.do" id="zhiyuanForm">
		<table class="grid" cellspacing="1" width="100%">
			...
			<tr>
				...
				<td>
				    ${zhiyuan.accountname}
					<input name="accountname" placeholder="工号" validate="{required:true,messages:{required:'请输入工号'}}" value="${requestScope.zhiyuan.accountname}" class="input-txt" type="hidden" id="txtAccountname" />
				</td>
